...
class library:
            ...
            books_col.insert_many([
                {
                    ...
                    "total_count": 1,
                    "available_count": 1,
                    "view_count": 0        # <-- NEW: start views at 0
                }
    ...
    def display(self):
        ...
        for doc in books_col.find().sort("book_id", 1):
            print(
                f"ID: {doc['book_id']} | {doc['title']} | "
                f"Total: {doc['total_count']} | "
                f"Available: {doc['available_count']} | "
                f"Views: {doc.get('view_count', 0)}"
            )
        print()

    # -------- View a book by ID and increment DB view_count --------
    def view_book(self):
    ...
    # -------- Show most/least viewed books using DB counts --------
    ...
    # -------- Borrow (decrement available_count) --------
    def borrow_book(self, book_id):
        ...
        if res.modified_count:
            ...
            borrow_date = datetime.timezone.utc
    ...
    # -------- Return (increment available_count) --------
    ...
    # -------- Sort books by title with counts & views --------
    def sort_books(self):
    ...
    # -------- Donate (increment total/available counts or add new) --------
